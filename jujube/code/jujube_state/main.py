...
transform_train = transforms.Compose([
    transforms.RandomResizedCrop(size=32, scale=(0.7, 1.0), ratio=(3./4., 4./3.)),
...
trainset = torchvision.datasets.ImageFolder(root='../../data_fool', transform=transform_train)

trainloader = torch.utils.data.DataLoader(trainset, batch_size=1, shuffle=True, num_workers=2)

# testset = torchvision.datasets.CIFAR10(root='./data', train=False, download=True, transform=transform_test)
testset = torchvision.datasets.ImageFolder(root='../../data_fool', transform=transform_test)
testloader = torch.utils.data.DataLoader(testset, batch_size=1, shuffle=False, num_workers=2)

classes = ('beak', 'breach', 'distortion', 'good', 'mould', 'wizened')
